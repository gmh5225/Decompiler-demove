module 0x1::stake {
    ...
    public(friend) fun copy_aptos_coin_mint_cap_for_storage_refund() : 0x1::coin::MintCapability<0x1::aptos_coin::AptosCoin> acquires AptosCoinCapabilities {
        borrow_global<AptosCoinCapabilities>(@0x1).mint_cap
    }
